...
${this.fragmentSrc}`;
  ...
  // node_modules/@pixi-essentials/area-allocator/lib/area-allocator.es.js
  var AreaOrientation;
  (function(AreaOrientation2) {
    const HORIZONTAL = 0;
    AreaOrientation2[AreaOrientation2["HORIZONTAL"] = HORIZONTAL] = "HORIZONTAL";
    const VERTICAL = 1;
    AreaOrientation2[AreaOrientation2["VERTICAL"] = VERTICAL] = "VERTICAL";
  ...
  var SPLIT_ORIENTATION;
  (function(SPLIT_ORIENTATION2) {
    const HOR = 0;
    SPLIT_ORIENTATION2[SPLIT_ORIENTATION2["HOR"] = HOR] = "HOR";
    const VERT = 1;
    SPLIT_ORIENTATION2[SPLIT_ORIENTATION2["VERT"] = VERT] = "VERT";
    const NONE = 2;
    SPLIT_ORIENTATION2[SPLIT_ORIENTATION2["NONE"] = NONE] = "NONE";
  ...
  var GuilloteneAllocator = class {
    ...
    findAreaRecursive(rootArea, aw, ah) {
      const frame = this.getFrame(rootArea, tempRect3);
      ...
      for (let i = 0, j = children.length; i < j; i++) {
        ...
        const candidateFrame = this.getFrame(candidate, tempRect3);
    ...
    split(area, areaFrame, holeFrame, orientation = this.getParent(area) ? this.splitOrientation(areaFrame, holeFrame) : SPLIT_ORIENTATION.HOR) {
      if (area[2] === true) {
      ...
      return this[orientation === SPLIT_ORIENTATION.HOR ? "splitPrimaryHorizontal" : "splitPrimaryVertical"](area, areaFrame, holeFrame);
    }
  ...
  var TextureAllocator = class {
    ...
    issueTexture(slab, width, height, padding = 0) {
      ...
      tempRect4.copyFrom(area);
      tempRect4.pad(-padding);
      const baseTexture = slab.slab;
      const issuedTexture = this.createTexture(baseTexture, tempRect4.clone());
...
//# sourceMappingURL=texture-allocator.iife.js.map
